...
from DXW_Strategy import DXW_Strategy
...
def after_code_changed(context):  # 输出运行时间
    ...
    if g.portfolio_value_proportion[0] > 0:
        ...
        # 补仓卖出
        run_weekly(dxw_clear, 5, time='9:30')
        # 选股
        run_daily(dxw_select, time='09:00')
        # 每日交易
        run_daily(dxw_adjust, time='9:30')
        ...
        # 补仓买入
        run_daily(dxw_append_buy_stock, time='14:50')
        # 收盘
