...
# -- 跟单代码
from apiserver_高收益小市值组合策略 import api_order, api_order_target, api_order_value, api_order_target_value

order = api_order(order)
order_target = api_order_target(order_target)
order_value = api_order_value(order_value)
order_target_value = api_order_target_value(order_target_value)
