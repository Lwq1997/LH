...
text = {
    ...
    "固定交易数量": 100,
    "特殊交易标的设置": "特殊交易标的设置",
    "特殊交易标的": ['511360.SH', '159651.SZ', '511580.SH', '511380.SH', '159649.SZ', '511270.SH',
    ...
    '自定义股票池': "自定义股票池设置",
    "股票池设置": "持有限制10的股票池设置",
    "股票池": ["513100.SH", "510300.SH", "159937.SZ", "512800.SH", "159659.SZ", "510050.SH",
               "159830.SZ", "511130.SH", "159655.SZ", "159581.SZ", "513400.SH", "159680.SZ",
               "159501.SZ", "159605.SZ", "159941.SZ", "513850.SH", "513310.SH", "159915.SZ",
               "159655.SZ", "159351.SZ", "511090.SH"],
    "股票池名称": ["纳斯达克ETF", "沪深300ETF", "黄金ETF", "银行ETF", "纳斯达克ETF", "上证50ETF",
                   "上海黄金ETF", "30年债券ETF", "标普ETF", "红利ETF", "道琼斯ETF", "中证1000ETF",
                   "纳斯达克ETF", "中概互联网ETF", "纳斯达克ETF", "美国50ETF", "中韩半导体ETF",
                   "创业板ETF", "标普ETF", "A500指数ETF", "30年债券ETF"],
}
...
def init(c):
    ...
    # c.run_time("run_tarder_func","1nDay","2024-07-25 09:34:00")
...
def get_mean_line_analyis(c):
    ...
    df = pd.DataFrame()
    line = text['价格站上N日线买入']
    df['证券代码'] = a.trade_code_list
    df['名称'] = a.trade_code_name
    print(df)
